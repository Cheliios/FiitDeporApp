                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          content: Column(
                            ...
                            children: [
                              Text(
                                "Queríamos agradecerles por utilizar nuestra primera aplicación desarrollada en Flutter, una calculadora. Apreciamos su confianza al elegir nuestra aplicación y esperamos que les haya gustado y les haya sido útil.",
                                style: TextStyle(
